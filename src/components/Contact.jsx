...
const WA_NUMBER = '56993944317';
const WA_MSG = encodeURIComponent('Hola, me gustaría información sobre el arriendo de vehículos Paolo Rent a Car');

function Contact() {
  const { config } = useConfig();

  const contactItems = [
    { Icon: Phone, label: 'Teléfono', value: '+56 9 9394 4317', href: 'tel:+56993944317', whatsapp: true },
    { Icon: Mail, label: 'Email', value: 'contacto@paolocar.cl', href: 'mailto:contacto@paolocar.cl' },
        ...
        <div className="grid gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-8">
              {contactItems.map(({ Icon, label, value, href, whatsapp }, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <a href={href} className="text-white whitespace-pre-line hover:text-gold-500 transition-colors duration-300">
                        {value}
                      </a>
                      {whatsapp && (
                        <a
