...
function WhatsAppButton() {
  ...
  const message = encodeURIComponent(config.whatsappMessage || 'Hola, me gustaría información sobre el arriendo de vehículos');
  ...
  return (
    ...
    >
      ...
      <div className="relative w-14 h-14 bg-obsidian-800 border border-gold-500/40 group-hover:border-gold-500 flex items-center justify-center transition-all duration-300 shadow-gold">
        ...
        <svg
          className="w-6 h-6 text-green-400 group-hover:scale-110 transition-transform duration-300 relative z-10"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
