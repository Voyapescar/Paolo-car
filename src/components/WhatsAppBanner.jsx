    ...
    <div className="bg-obsidian-800 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <a
          ...
          className="flex items-center gap-2 text-gold-500 hover:text-gold-400 border border-gold-500/30 hover:border-gold-400/50 px-5 py-2 text-xs tracking-[0.15em] uppercase font-medium transition-colors duration-300"
        >
          <WA_ICON />
